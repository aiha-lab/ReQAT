...
INT3_G32_WEIGHT_ONLY_CFG = {
    "quant_cfg": {
        "*weight_quantizer": {"num_bits": 3, "block_sizes": {-1: 32}, "enable": True},
        "*input_quantizer": {"enable": False},
        **_default_disabled_quantizer_cfg,
    },
    "algorithm": None,
...
MXFP4_W4A4_EXCLUDE_DOWN_CFG = {
    "quant_cfg": {
        ...
        **_default_disabled_quantizer_cfg,
        "*down_proj.weight_quantizer": {"enable": False},
        "*down_proj.input_quantizer": {"enable": False},
    },
    "algorithm": None,
}

MXFP4_W4A4_FC2_FP8_CFG = {
    "quant_cfg": {
        "*weight_quantizer": {
            "num_bits": (2, 1),
            "block_sizes": {-1: 32, "type": "dynamic", "scale_bits": (8, 0)},
        ...
        "*down_proj.weight_quantizer": {
            "num_bits": (4, 3),
            "block_sizes": {-1: 32, "type": "dynamic", "scale_bits": (8, 0)},
            "enable": True,
        },
        "*down_proj.input_quantizer": {
            "num_bits": (4, 3),
            "block_sizes": {-1: 32, "type": "dynamic", "scale_bits": (8, 0)},
            "enable": True,
        },
...
MXFP4_BLOCK_ROTATION_WEIGHTONLY_CFG = {
    "quant_cfg": {
        "*weight_quantizer": {
            "num_bits": (2, 1),
            "block_sizes": {-1: 32, "type": "dynamic", "scale_bits": (8, 0)},
...
MXFP4_BLOCK_ROTATION_NOFINALMLP_CFG = {
    "quant_cfg": {
        "*weight_quantizer": {
            "num_bits": (2, 1),
            "block_sizes": {-1: 32, "type": "dynamic", "scale_bits": (8, 0)},
        ...
        **_default_disabled_quantizer_cfg,
        "*layers.47.mlp*weight_quantizer": {"enable": False},
        "*layers.47.mlp*input_quantizer": {"enable": False},
    },
    "algorithm": None,
}
...
NVFP4_W4A4_DOWN_PROJ_SCALE32_CFG = {
    "quant_cfg": {
        "*weight_quantizer": {
            "num_bits": (2, 1),
            "block_sizes": {-1: 16, "type": "dynamic", "scale_bits": (4, 3)},
        ...
        "*down_proj.input_quantizer": {
            "num_bits": (4, 3),
            "block_sizes": {-1: 16, "type": "dynamic", "scale_bits": (6, 9)},
            "enable": True,
        },
        **_default_disabled_quantizer_cfg,
    },
...
NVFP4_W4A4KV4_BLOCK_ROTATION_CFG = {
    "quant_cfg": {
        "*weight_quantizer": {
            "num_bits": (2, 1),
            "block_sizes": {-1: 16, "type": "dynamic", "scale_bits": (4, 3)},
...
class QuantizerAttributeConfig(ModeloptBaseConfig):
    ...
    block_rotation_size: int | None = ModeloptField(
        default=None,
        title="""Block size for block-wise randomized Hadamard transform.""",
        description=""""If set to a positive integer, block-wise randomized Hadamard transform will be used.
        The input dimension must be divisible by this block size. This enables block rotation
        as used in Quartet quantization method.
        
        For example, if block_rotation_size=128, the input will be divided into blocks of size 128,
        and each block will be rotated independently using a randomized Hadamard transform.
        
        Requires ``rotate=True`` to be enabled. If both ``block_rotation_size`` and ``randomized_rotate``
        are set, block rotation will take precedence.
        
        Recommended values are powers of 2 (e.g., 32, 64, 128, 256) for best performance.""",
    )
