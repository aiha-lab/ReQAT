...
def parser_gen():
    ...
    parser.add_argument('--dataset', type=str, default='AIME-2024',
                        choices=["AIME-2024", "AIME-2025", "AIME-90", "MATH-500", "NuminaMath-1.5", "GSM8K", "GPQA-Diamond", "LiveCodeBench"],
    ...
    parser.add_argument('--top_k', type=int, default=-1, help='Generation top_k')
    ...
    # Qwen3-like Thinking Budget
    parser.add_argument('--thinking_budget', type=int, default=-1,
                        help='Qwen3-like Thinking Budget.')
    parser.add_argument('--generated_jsonl_path', type=str, default=None)
    args = parser.parse_args()

    # output path
    args.model_name = args.model.split("/")[-1]
    args.model_name = args.model_name.split("-tp")[0]
...
def main(args):
    ...
    results, details = vllm(
        ...
        thinking_budget=args.thinking_budget, # Qwen3 Thinking Budget
        generated_jsonl_path=args.generated_jsonl_path,
        **task_kwargs,
    )
